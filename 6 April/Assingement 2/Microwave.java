...
A value 100 or higher shows seconds as the last two digits and minutes and the higher digits. 
So 100 means 1:00 (one minute zero seconds), 134 means 1:34 (one minutes 34 seconds), 1238 means 12:38 (twelve minutes 38 seconds), and so on.
...
Then use four successive single-branch if statements each of 
which tests for one of the four cases: 1 item, 2 items, 3 items, more than three items.
